...
onMounted(() => {
  ...
  function createGround() {
    ...
    // const cubeFolder = gui.addFolder('Ground')
    // cubeFolder.add(groundMesh.rotation, 'x', 0, Math.PI).listen()
    // cubeFolder.add(groundMesh.rotation, 'y', 0, Math.PI * 2).listen()
    // cubeFolder.add(groundMesh.rotation, 'z', 0, Math.PI * 2).listen()
    // cubeFolder.open()
  ...
  // cubeFolder.add(camera.position, 'x', -1500, 1500).listen()
  // cubeFolder.add(camera.position, 'y', -1500, 1500).listen()
  // cubeFolder.add(camera.position, 'z', -1500, 1500).listen()
  // cubeFolder.add(controls, 'enabled').listen()
  // cubeFolder.open()
